...
class EthicalKernelVerifierTest {
    ...
    @Test
    fun partnerAuthorizedUpdate_withEmptyToken_logsUnauthorizedWithoutTokenDetails() {
        ...
        verify(exactly = 0) { Log.e("EthicalKernelVerifier", match { it.contains("empty auth token") }) }
    }
